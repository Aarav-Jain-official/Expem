            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
                        <h1
                            className="text-3xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                            <span
                    ...
                    <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
                        ...
                        HANDLE YOUR MONEY SMARTLY
                           ...
                           <Link to="/login">
                        <button className= " text-white font-bold px-6 py-3 rounded-lg bg-green-700 hover:bg-green-800 text-xl">
  Login
</button>
</Link>
<Link to="/register">
<button className="ml-10 text-white font-bold px-6 py-3 rounded-lg bg-green-700 hover:bg-green-800 text-xl">
  Register
</button>
</Link>
                    </motion.div>
